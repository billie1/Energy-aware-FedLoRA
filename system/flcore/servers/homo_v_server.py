...
from flcore.clients.homo_v_client import clientHomoLoRA
...
class serverHomoLoRA(Server):
    def __init__(self, args, times, env, rsu, task):
        ...
        print(f"Total LoRA parameters: {self.total_lora_params/1e6} M")
    ...
    def aggregate_parameters(self):
        ...
        for key in agg_state_dict:
            if 'lora' in key:
                # Stack and average across client updates
